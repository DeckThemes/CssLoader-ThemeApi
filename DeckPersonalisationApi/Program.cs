...
builder.Services.AddCors(options =>
{
    ...
    {
        policy
            .WithOrigins(configuration.CorsAllowedOrigins.ToArray())
            .WithHeaders(configuration.CorsAllowedHeaders.ToArray())
            .WithMethods(configuration.CorsAllowedMethods.ToArray());
    });
});
